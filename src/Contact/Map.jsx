  ...
  return (
    <section className="font-jakarta bg-white py-24">
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="mb-10">
          <span className="text-[#f97316] text-xs font-bold uppercase tracking-widest">Find Us</span>
        ...
        <div className="relative rounded-2xl overflow-hidden border border-[#e2e8f0] h-[420px]">
          <iframe
            title="CityCare Plumbing service area map"
            src="https://www.google.com/maps?q=Midwest%20Region%2C%20US&output=embed"
          ...
          <div className="absolute bottom-4 left-4 right-4 sm:right-auto bg-white rounded-2xl shadow-xl border border-[#e2e8f0] p-5 flex items-center gap-4 max-w-sm">
            ...
            <div className="flex-1">
              <p className="text-[#0f172a] font-bold text-sm">CityCare Plumbing HQ</p>
              <p className="text-[#64748b] text-xs mt-0.5">Midwest Region, US</p>
            </div>
            <a
              href="https://www.google.com/maps/dir/?api=1&destination=Midwest+Region,+US"
              target="_blank"
