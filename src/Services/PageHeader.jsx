...
export default function PageHeader() {
  return (
    <section className="font-jakarta bg-[#1a2f4e] overflow-hidden relative">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#1a2f4e]/95 via-[#1a2f4e]/80 to-[#1a2f4e]/50" />
      </div>
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-6 py-20 sm:py-24">
        ...
        <h1 className="text-5xl sm:text-[60px] font-extrabold text-white leading-[1.05] tracking-tight mb-5 max-w-2xl">
          Our Plumbing<br />Services
        </h1>
        <p className="text-blue-200 text-lg max-w-lg leading-relaxed mb-8">
          From emergency call-outs to full pipe replacements — residential
          and commercial plumbing across the Midwest. Available 24/7.
        </p>
